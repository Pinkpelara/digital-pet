...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-ink/8 bg-paper/90 text-ink backdrop-blur-md">
      <a
        href="#content"
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3 md:px-8">
        <Link href="/" className="flex items-baseline gap-3">
          <span className="font-display text-[1.55rem] tracking-tight">{brand.name}</span>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            {hydrated && !creaturesEnabled ? "Show roamers" : "Pause roamers"}
          </button>
          <Link
            href="/my-companions"
