export const brand = {
  ...
  hero: "Chunky screen companions. Adopt one. Dress it. Teach it tricks. Keep them on the website, pin them in a browser, or optionally bring them to a desktop app.",
