  ...
  return (
    <article className="bg-paper pb-20">
      ...
      <div className="mx-auto max-w-2xl space-y-4 px-5 text-lg text-ink-soft md:px-10">
        <p>
          They are there when you are, and nothing bad happens when you are away. No hunger, no
          streaks, no guilt. Loud fun is always your choice, never the default.
        </p>
        <p>
        ...
        <p>
          ...
          separate currency, no social feed. Accounts and payments are for adults; the tone is for
          anyone {brand.ageGate}.
        </p>
