...
export default async function ItemPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (!product) notFound();
  const species = product.speciesId ?? (product.looksGoodWith.includes("companion-mochi") ? "mochi" : product.looksGoodWith.includes("companion-niblet") ? "niblet" : product.looksGoodWith.includes("companion-sprout") ? "sprout" : "bloop");
